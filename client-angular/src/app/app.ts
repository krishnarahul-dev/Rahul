...
users: DemoUser[] = [
  ...
  { id: 'a1b2c3d4-0005-4000-8000-000000000005', cflow_id: 'cflow_1005', name: 'Karthik Rajan', email: 'karthik@cflow.dev' },
  ...
  { id: 'a1b2c3d4-0004-4000-8000-000000000004', cflow_id: 'cflow_1004', name: 'Sneha Iyer', email: 'sneha@cflow.dev' },
];
